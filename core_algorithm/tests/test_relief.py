...
from lalo_core.appearance import SilhouetteFeature, SurfaceFace, SurfaceMap
from lalo_core.body import PartSpec
from lalo_core.relief import apply_relief_to_shape, compile_part_relief, mesh_detailed_part
